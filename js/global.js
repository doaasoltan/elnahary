...
// تحقق مما إذا كان المتصفح يدعم تخزين المتصفح
if (typeof Storage !== "undefined") {
  // احصل على عدد الزيارات من تخزين المتصفح، أو اضبطه على 0 إذا لم يكن موجودًا
  count = parseInt(localStorage.getItem("visitorCount")) || 0;

  // قم بتحديث عدد الزيارات في عنصر العداد
  counterElement.textContent = `Visitor Count: ${count}`;

  // قم بزيادة عدد الزيارات وتخزينه في تخزين المتصفح
  count++;
  localStorage.setItem("visitorCount", count);
} else {
  // المتصفح لا يدعم تخزين المتصفح، لذا لا يمكن تتبع عدد الزيارات
  counterElement.textContent = "Visitor Count: N/A";
}
